...
- 课程/培训型要像老师备课：学习目标/动机 -> 核心概念 -> 最小案例 walkthrough -> 类型或流程 -> 常见误区 -> 小结/练习；最小案例页优先用 `组件：example_walkthrough`。
...
- 可用组件：rich_cards、fact_grid、timeline、process、example_walkthrough、stat_callout、quote_block、card_grid、two_column、three_column、horizontal、table、summary。
...
组件：{{rich_cards / fact_grid / timeline / process / example_walkthrough / stat_callout / quote_block / card_grid / table，可省略}}
